...
/// with their official, newly-introduced symbols via bundled fonts. Every
/// other world currency is supported generically, resolved from a locale
/// (or the device's current locale) using `package:intl`'s standard
/// currency data.
