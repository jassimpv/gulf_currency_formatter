...
class AedText extends StatelessWidget {
  const AedText(
    this.value, {
    super.key,
  ...
  /// The base text style. [AedCurrencyFormatter.symbolFontFamily] is applied
  /// on top of this style so the Dirham glyph always renders correctly.
  ...
  Widget build(BuildContext context) {
    final List<InlineSpan> spans = buildCurrencySymbolSpans(
      value: value,
      symbolText: AedCurrencyFormatter.symbol,
      symbolFontFamily: AedCurrencyFormatter.symbolFontFamily,
